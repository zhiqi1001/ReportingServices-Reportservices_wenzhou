<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceptionDataGroupSyncRpt.aspx.cs" Inherits="ReportingServices.ExceptionDataGroupSyncRpt" MasterPageFile="~/Site1.Master" %>
...
<%--                <asp:ListItem Text="3号机组" Value="3"></asp:ListItem>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="1209px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1270px" ProcessingMode="Remote">
            <ServerReport ReportPath="/ExceptionData_Group_Sync"/>
        </rsweb:ReportViewer>
    </div>
</asp:Content>