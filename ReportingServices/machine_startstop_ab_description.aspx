<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="machine_startstop_ab_description.aspx.cs" Inherits="ReportingServices.machine_startstop_ab_description" MasterPageFile="~/Site1.Master" %>
            ...
            $("button[name='btn-edit']").click(function () {
                ...
                if (isedit) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/api/Rulelog/',
                        data: { id: id, description: description, typeid: 1 },
                        datatype: "json",
                        beforeSend: function () {
                            $modal.modal();
                        },
